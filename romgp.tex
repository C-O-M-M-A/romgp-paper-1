...
\begin{document}
    ...
    \section{Methodology} \label{sec:Method}
        ...
        \subsection{Global Sensitivity Analysis} \label{sub:Method:GSA}
            ...
            \Crefrange{eq:Method:GP:Kernel}{eq:Method:GSA:uDist} enable analytic integration using \Crefrange{eq:Method:marginalization}{eq:Method:product} to yield
