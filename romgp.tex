    ...
    \section{Methodology} \label{sec:Method}
        ...
        \subsection{Global Sensitivity Analysis} \label{sub:Method:GSA}
            ...
            \begin{equation} \label{eq:Method:GSA:DmDef}
                D_{\vr{m}} \deq \var{f_{\vr{m}}((\vr{u})_{\vr{m}})}
            ...
            \begin{equation} \label{eq:Method:GSA:SDef}
                S_{\vr{m}} \deq D_{\vr{m}}/D_{\vr{M}} \leq S_{\vr{M}} = 1
            \end{equation}
            Analytic expressions for $\partial_{\Theta} D_{\vr{m}}$ have been obtained from \cref{eq:Method:GSA:DmDef} using standard formulae for differentating matrix inverses and determinants. As $D_{\vr{m}}$ projects $M$-dimensional $\vr{x}$ onto $m$-dimensional $\vr{u}$, the result is affected by just a few components of rotation:
            \begin{equation} \label{<label>}
                \left(\partial_{\Theta} D_{\vr{m}}\right)_{i \times j} \neq 0 \quad \Longrightarrow \quad i \leq m < M
            \end{equation}
        ...
        \subsection{Basis Optimization} \label{sub:Method:BO}
            ...
            \begin{equation} \label{eq:Method:BO:Rotation}
                (\Theta)_{\vr{m}\times\vr{M}} = (\Xi)_{\vr{m}\times\vr{M}} (\hat{\Theta})_{\vr{M}\times\vr{M}}
            \end{equation}
            ...
            \begin{equation} \label{eq:Method:BO:Rotation}
                (\Xi)_{m\times\vr{M}\setminus\vr{m}} = \argmax S_{\vr{m}} = \argmax D_{\vr{m}}
            \end{equation}
            The optimal row $m$ is then incorporated in $\hat{\Theta}$ and $\Xi$ according to
            \begin{equation} \label{eq:Method:BO:Rotation}
                \begin{aligned}
                    \hat{\Theta} &= \vr{Q}^{\intercal} \quad \text{where} \Theta^{\intercal} = \vr{Q}\vr{R} \text{ is the QR factorization of the update} \\
        ...
        \subsection{Summary} \label{sub:Method:BO}
            The main loop 
